...
- dependencies ( for linux mint / ubuntu based)

```bash
sudo apt update && sudo apt install mpv rofi jq socat libnotify-bin bash
...
_Idea by me, code partly “magically” generated by ChatGPT 😉_
